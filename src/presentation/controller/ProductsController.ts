...
export class ProductsController {
    constructor(
        ...
        private searchProductsPaginatedUseCase: SearchProductsPaginatedUseCase,
    ...
    async search(req: Request, res: Response) {
        try {
            const { name, test, page, limit } = req.query;
            ...
            if (hasPagination) {
                ...
                const result = await this.searchProductsPaginatedUseCase.execute({
                    name,
    ...
    async filter(req: Request, res: Response) {
        try {
            const { categories, minPrice, maxPrice, status, page, limit, sortOrder } = req.query;
